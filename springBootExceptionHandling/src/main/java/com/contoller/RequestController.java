...
public class RequestController {
	...
	public ResponseEntity<Object> addStudent(@RequestBody Person person) throws Exception, PersonAlreadyExists {
	...
	public ResponseEntity<Object> deletePerson(@RequestParam("id") Short id) throws PersonNotFound{
		personService.deletePerson(id);
		return new ResponseEntity<>(HttpStatus.OK);
	}
	
	@PutMapping("/updateStudent")
	public ResponseEntity<Object> updatePerson(@RequestBody Person person) throws PersonNotFound {
